import numpy as np
from wavefronts_Xsource_truedirection_wctoymodel import *
...
We use the reconstructed Xsource from spherical reconstruction (to decrease the value of the reconstructed Cherenkov angle).
We compute the Cherenkov angle from the toy model.
We only use simulations at high frequencies [150, 200] MHz because the Cherenkov angle is further from the shower axis for simulations.
Goal: see if we can better locate the Cherenkov peak in these conditions.
'''
...
output_directory = '/Users/mguelfan/Documents/GRAND/ADF_DC2/output_recons_starshape/nonoise_50200MHZ_threshold70uV_truedirection_Xsource_wc_toymodel/'
