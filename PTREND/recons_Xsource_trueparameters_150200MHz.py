import numpy as np
from wavefronts_Xsource_trueparameters_150200MHz import *
...
We use the reconstructed Xsource from spherical reconstruction (to decrase the reconstructed Cherenkov angle).
...
output_directory = '/Users/mguelfan/Documents/GRAND/ADF_DC2/output_recons_starshape/output_truedirection_Xsource_cherenkovtoymodel/'
