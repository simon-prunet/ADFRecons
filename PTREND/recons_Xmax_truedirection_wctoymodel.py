import numpy as np
from wavefronts_Xmax_truedirection_wctoymodel import *
...
We use the true Xmax from simulation.
We compute the Cherenkov angle from the toy model for delta = 5km or delta = 2km.
Goal: see if we can better locate the Cherenkov peak in these conditions for vertical EAS.
'''
...
output_directory = '/Users/mguelfan/Documents/GRAND/ADF_DC2/output_recons_starshape/nonoise_150200MHZ_threshold50uV_truedirection_Xmax/'
