import numpy as np
from wavefronts_Xsource_truedirection_omegac_simus import *
import sys
import os
...
output_directory = '/Users/mguelfan/Documents/GRAND/ADF_DC2/ADFRecons/recons_truedirection_Xsource_omegac_simus/nonoise_energyelec/'
...
def main():
    ...
    if (st.recons_type==2):
        ...
        for current_recons in range(co.ncoincs):
            ...
            #if table_cherenkov_simu.size > 0 and current_id in table_cherenkov_simu[:, 0]:
        ...
        #for current_recons in range(len(length_data)):
            ...
            #for current_recons in range(len(fid_input_angles)):
                ...
                if theta_in  == -1.0 or Xmax[0] == -1.0:
                    ...
                    res_3D_before_after_Xmax = minimize(ADF_3D_loss_before_after_Xmax,params_in,args=args, method='migrad')
